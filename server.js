...
let data = {
  hotel: { 
    profile: { 
      ...
      email: "contact@larche-hotel.com"
    } 
  },
  rooms: [
    { id: "1", roomNumber: "101", type: "standard", floor: "1", price: "150", status: "available", maxOccupancy: "2", amenities: ["WiFi", "TV", "AC"], createdAt: new Date().toISOString() },
    { id: "2", roomNumber: "201", type: "deluxe", floor: "2", price: "250", status: "available", maxOccupancy: "3", amenities: ["WiFi", "TV", "AC", "Mini Bar"], createdAt: new Date().toISOString() },
    { id: "3", roomNumber: "301", type: "suite", floor: "3", price: "450", status: "available", maxOccupancy: "4", amenities: ["WiFi", "TV", "AC", "Mini Bar", "Jacuzzi"], createdAt: new Date().toISOString() }
  ],
  venues: [
