...
let data = {
  ...
  rooms: [
    ...
    { id: "5", roomNumber: "202", type: "deluxe", floor: "2", price: "250", status: "available", maxOccupancy: "3", amenities: ["WiFi", "TV", "AC", "Mini Bar"], images: ["/logo14.PNG"], createdAt: new Date().toISOString() },
